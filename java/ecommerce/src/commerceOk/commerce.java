...
public class commerce {
	...
	public static void main(String[] args) {
		...
		double valorSoma[] = new double[minimo];
		...
		while (user==true)
		{
			...
			for (x = 0; x<10; x++)
			{
				...
				if (codigo[x]> 10)
				{
					System.out.println("\nCÓDIGO NÃO EXISTE, TENTE NOVAMENTE !\n");
					System.out.print("Por favor, digite o código do produto que deseja: ");
				}
				...
				{	
					...
					else 
					{
						...
						valorCompras[0] =valorCompras[0] + valorCompras[0];
						valorSoma[0] = valorSoma[0] + valorCompras[0];	
				...
				{					
					...
					valorSoma[1] = valorSoma[1] + valorCompras[1];
					}
				...
				if (codigo[x] == 3)
				{
					...
					else 
					{
						...
						valorSoma[2] = valorSoma[2] + valorCompras[2];
					}
				...
				if (codigo[x] == 4)
				{
					...
					else 
					{
						...
						valorSoma[3] = valorSoma[3] + valorCompras[3];
					}
				...
				if (codigo[x] == 5)
				{
					...
					else 
					{
						...
						valorSoma[4] = valorSoma[4] + valorCompras[4];
					}
				...
				if (codigo[x] == 6)
				{
					...
					else 
					{
						...
						valorSoma[5] = valorSoma[5] + valorCompras[5];
					}
				...
				if (codigo[x] == 7)
				{
					...
					{											
						...
						valorSoma[6] = valorSoma[6] + valorCompras[6];
					}
				...
				if (codigo[x] == 8)
				{
					...
					else 
					{
						...
						valorSoma[7] = valorSoma[7] + valorCompras[7];
					}
				...
				if (codigo[x] == 9)
				{
					...
					else
					{
						...
						valorSoma[8] = valorSoma[8] + valorCompras[8];
					}
				...
				if (codigo[x] == 10)
				{
					...
					else
					{
						...
						valorSoma[9] = valorSoma[9] + valorCompras[9];
					}
				...
				for (x = 0; x < minimo; x++ )
				{
					valorTotal = valorTotal + valorSoma[x];
					
					if (compras[x] != null) 
					{
										
					System.out.println((x + 1)+" - "+compras[x]+"\t"+"R$ "+ valorSoma[x]+"\t\t"+totalQuantidade[x]+" - und.\n");
				 ...
				 if (notaFiscal == 'S')
					{
						...
						for(x = 0; x < minimo; x++ )
						{
							if ((compras[x] != null) || (valorSoma[x] > 0.0)) 
							{							
						...
						System.out.printf("---------------------IMPOSTOS A SEREM PAGOS R$ %.2f------------------",imp,"\n\n");			
